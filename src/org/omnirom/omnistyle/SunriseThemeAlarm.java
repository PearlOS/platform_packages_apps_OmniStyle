...
public class SunriseThemeAlarm extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        mOverlayCompose.add(OverlayUtils.KEY_THEMES_DISABLED);
        mOverlayCompose.add(OverlayUtils.KEY_THEMES_DISABLED);
        mOverlayCompose.set(0, prefs.getString("AccentDay", ""));
        mOverlayCompose.set(1, prefs.getString("PrimaryDay", ""));
        mOverlayCompose.set(2, prefs.getString("NotificationDay", ""));
        ...
        Log.d("ThemeAlarm", "Alarm fired sunrise");
